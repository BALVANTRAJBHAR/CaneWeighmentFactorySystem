...
public class DotMatrixEscPRenderer : IPrintRenderer
{
    ...
    private static SKBitmap Draw(PrintDocument doc)
    {
        ...
        if (!string.IsNullOrWhiteSpace(doc.SeasonName))
            canvas.DrawShapedText(shaperRegular, $"Season: {doc.SeasonName}", new SKPoint(WidthPx - 260, y), SKTextAlign.Left, valueFont, paint);
        y += 12;
        canvas.DrawLine(10, y, WidthPx - 10, y, paint);
        y += 12;
        ...
        canvas.DrawLine(10, y, WidthPx - 10, y, paint);
        y += 22;
        canvas.DrawShapedText(shaperRegular, $"Generated By: {doc.GeneratedByUserName}", new SKPoint(10, y), SKTextAlign.Left, valueFont, paint);
