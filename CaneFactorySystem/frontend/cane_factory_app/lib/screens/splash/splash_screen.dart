...
class SplashScreen extends StatefulWidget {
  ...
  const SplashScreen({super.key, required this.statusText, this.hasError = false, this.onRetry, this.companyName});
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: accent.withValues(alpha: isDark ? 0.35 : 0.22), blurRadius: 32, spreadRadius: 2),
                        ],
                      ),
                    ...
                    Text('Cane Factory Management System',
                        ...
                        style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: textColor, letterSpacing: 0.2)),
                    if (widget.companyName != null && widget.companyName!.isNotEmpty) ...[
                      const SizedBox(height: 6),
                      Text(widget.companyName!,
                          style: TextStyle(fontSize: 14, color: textColor.withValues(alpha: 0.65), fontWeight: FontWeight.w500)),
                    ],
                    ...
                    if (!widget.hasError)
                      ...
                      Icon(Icons.cloud_off_outlined, size: 34, color: Theme.of(context).colorScheme.error),
                    ...
                    Padding(
                      ...
                      child: Text(widget.statusText,
                          ...
                          style: TextStyle(
                              fontSize: 13,
                              color: widget.hasError ? Theme.of(context).colorScheme.error : textColor.withValues(alpha: 0.7))),
                    ),
