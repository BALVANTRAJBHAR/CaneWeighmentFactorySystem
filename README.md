...
For multi-PC LAN, web, and mobile deployment, see
[`docs/NETWORK_DEPLOYMENT_GUIDE.md`](docs/NETWORK_DEPLOYMENT_GUIDE.md). A
production client must use the factory server URL rather than `localhost`.
